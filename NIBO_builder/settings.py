"""
Django settings for NIBO_builder project.
...
MIDDLEWARE = [
    ...
    # 'examiner.middleware.SetSessionLoggedInMiddleware',
]

ROOT_URLCONF = 'NIBO_builder.urls'
...
WSGI_APPLICATION = 'NIBO_builder.wsgi.application'
