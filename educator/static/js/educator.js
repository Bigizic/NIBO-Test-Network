...
function createNextQuestion() {
  ...
  display: none; z-index: 3; right: 2%; width: 0; height: 80%; overflow-y: scroll;">
              ...
              <ul class="question_links_ul" style="list-style-type: none; padding: 35px 0px 0px 30px;">
                  <li>
                      <div class="question_wrap_input" style="position: relative;">
                          ...
                          <small style="display: flex; gap: 20px; margin-top: 15px;"><input class="media_link_to_question" style="font-size: 9.5px; font-weight: bolder; padding: 4px 10px; border-radius: 10px;" type="button" value="add media link to question"> <input class="media_link_to_answer" style="font-size: 9.5px; font-weight: bolder; padding: 4px 10px; border-radius: 10px;" type="button" value="add media link to answer 1"></small>
  ...
  $(document).on('click', '.add_more_links', function () {
    ...
    if (childrenLiLen < 5) {
      $('.question_links_ul').append(`
        ...
        <span class="question_new_input_span" data-placeholder=".png, .jpeg, .jpg, .gifs, .mp4 files are allowed"></span>
        <input class="question_new_input_check_mark" type="button" value="&#x2713" style="color: green; position: absolute; right: -20px; top: 35px;">
        <small style="display: flex; gap: 20px; margin-top: 15px;"><input class="media_link_to_question" style="font-size: 9.5px; font-weight: bolder; padding: 4px 10px; border-radius: 10px;" type="button" value="add media link to question"> <input class="media_link_to_answer" style="font-size: 9.5px; font-weight: bolder; padding: 4px 10px; border-radius: 10px;" type="button" value="add media link to answer ${childrenLiLen + 1}"></small>
        <img style="height: 160px; position: absolute; right: -250px; top: -10px;" class="question_image_viewport"/>
        </div>
        </li><br>`);
    }
...
$(document).on('click', '#add_more_question_button', function () {
  ...
  if (nearestUl.find('li').length > 16) {
    ...
    <span style="cursor: default; color: red; font-weight: 900; font-size: 13px; top: 25px; position: relative; left: 5px;" class="remove_li_questions">X</span></li>
    `);
  }
});
...
$(document).on('click', '.cancel_exam_create', function() {
  if (formCounter > 0) {
    ...
    $(`#create_questions_form${formCounter}`).slideUp();
